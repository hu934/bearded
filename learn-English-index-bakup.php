	...
	<body>
		<header id="head">
			...
			<div class="container">
				...
				<?php $recent = new WP_Query("page_id=783"); while($recent->have_posts()) : $recent->the_post();?>
				<div class="row-two">
					<div class="row-div">
					<!--<div class="bg-div"><img src="<?php echo get_template_directory_uri();?>/assets/ztime/img/1.png"/></div>-->
					<div class="row-div">
						<div class="video-bgdiv">					
						<!-- Insert to your webpage where you want to display the slider -->
						<div id="amazingslider-wrapper-1" style="display:block;position:relative;max-width:930px;margin:0px auto 0px;">
								...
								<ul class="amazingslider-slides" style="display:none;">
									...
									<?php  if( have_rows('slider_video') ):
										...
										<li>
											...
											<video preload="none" src="<?php echo $header_video;?>" ></video>
										</li>
		...
		<script src="<?php echo get_template_directory_uri();?>/assets/ztime/sliderengine/amazingslider.js"></script>
		<script src="<?php echo get_template_directory_uri();?>/assets/ztime/sliderengine/initslider-1.js"></script>
